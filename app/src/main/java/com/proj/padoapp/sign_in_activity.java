...
public class sign_in_activity extends AppCompatActivity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		biometricPrompt = new BiometricPrompt(sign_in_activity.this, executor, new BiometricPrompt.AuthenticationCallback() {
			@Override
			public void onAuthenticationError(int errorCode, @NonNull CharSequence errString) {
				super.onAuthenticationError(errorCode, errString);
				Toast.makeText(sign_in_activity.this, "Erro " + errString, Toast.LENGTH_LONG).show();
			}

			@Override
			public void onAuthenticationSucceeded(@NonNull BiometricPrompt.AuthenticationResult result) {
				super.onAuthenticationSucceeded(result);
				Toast.makeText(sign_in_activity.this, "Sucessfull", Toast.LENGTH_LONG).show();
			...
			public void onAuthenticationFailed() {
				...
				Toast.makeText(sign_in_activity.this, "AuthenticationFailed", Toast.LENGTH_LONG).show();
			}
		});
	...
	private void Switchcase(){
		switch (checkCredentials){
			case 1:
				Toast.makeText(sign_in_activity.this, "Usuário e senha estão corretos, mas o sistema apresentou falha durante o login", Toast.LENGTH_LONG).show();
				break;
			case 2:
				Toast.makeText(sign_in_activity.this, "Usuário não existe no sistema ou senha está incorreta", Toast.LENGTH_LONG).show();
				break;
			default:
				Toast.makeText(sign_in_activity.this, "Bem vindo ao Pado SmartLock, para acessar entre com usuário e senha ou cadastrese caso não tenha acesso.", Toast.LENGTH_LONG).show();
		}
	}
